...
void MyMQTT::begin(uint8_t paLevel, uint16_t frequency, RH_RF69::ModemConfigChoice modemChoice, void (*inDataCallback)(const char *, int *), uint8_t _rx, uint8_t _tx, uint8_t _er) {
